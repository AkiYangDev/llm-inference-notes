...
文章按主要阅读角色组织；专题、标签与系列阅读仍在网站中并行保留。

### 流量入口

面向第一次进入 AI Infra / SGLang 的读者，从更广泛的问题切入。
...
从概念进入实现，连接 Scheduler、ModelRunner、Attention、MoE、分布式与量化执行。
...
源码、性能、投机解码、Ascend Profiling 与 PR 级工程细节。
